...
function testimonial_slider_get_round($slider_handle,$r_array,$testimonial_slider_curr,$set,$echo='1',$data=array()){
	...
	if($testimonial_slider_curr['navnum'] == "2"){
		$nav_buttons_bottom='';
		$nav_buttons_top='<div class="testimonial_nav_arrow_wrap"><a class="testimonial_prev" id="'.esc_attr($slider_handle).'_prev" href="#" '.$testimonial_slider_css['testimonial_prev'].'><span>prev</span></a><a class="testimonial_next" id="'.esc_attr($slider_handle).'_next" href="#" '.$testimonial_slider_css['testimonial_next'].'><span>next</span></a></div>';
	}
	...
	<div id="'.esc_attr($slider_handle).'_wrap" class="testimonial_slider testimonial_slider_set'. $set .' testimonial_slider__'.esc_attr($stylesheet).'" '.$testimonial_slider_css['testimonial_slider'].'>
